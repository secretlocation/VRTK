...
namespace VRTK
{
    ...
    [System.Obsolete("`VRTK.VRTK_Button` has been replaced with `VRTK.Controllables.PhysicsBased.VRTK_PhysicsButton`. This script will be removed in a future version of VRTK.")]
