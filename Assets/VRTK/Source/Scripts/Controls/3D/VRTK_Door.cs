...
namespace VRTK
{
    ...
    [System.Obsolete("`VRTK.VRTK_Door` has been replaced with `VRTK.Controllables.PhysicsBased.VRTK_PhysicsDoor`. This script will be removed in a future version of VRTK.")]
